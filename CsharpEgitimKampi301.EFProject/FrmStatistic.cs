...
namespace CsharpEgitimKampi301.EFProject
{
    public partial class FrmStatistic : Form
    {
        ...
        private void FrmStatistic_Load(object sender, EventArgs e)
        {
            ...
            lblLastCountryName.Text = db.Location.Where(x => x.LocationId == lastCountryId).Select(y => y.Country)
                .FirstOrDefault();
            ...
            lblAyseLocationCount.Text=db.Location.Where(x=>x.GuideId==guideIdByNameAysegulCinar).Count().ToString();
        }
    }
}
